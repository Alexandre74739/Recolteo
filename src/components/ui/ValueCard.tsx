...
export default function ValueCard({
  ...
  return (
    <div className="flex items-start gap-5 bg-white border border-sapin rounded-2xl px-6 py-5 transition-transform duration-200 hover:translate-x-1.5 hover:-translate-y-1">
